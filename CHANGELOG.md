## 6.37.0 (April 28, 2023). Tested on Artifactory 7.49.8

IMPROVEMENTS:

* resource/artifactory_scoped_token: adds reference_token and include_reference_token attributes for the resource.
  PR [#724](https://github.com/jfrog/terraform-provider-artifactory/pull/724)
...
PR: [#709](https://github.com/jfrog/terraform-provider-artifactory/pull/709)

## 6.34.0 (March 21, 2023). Tested on Artifactory 7.49.8
...
* datasource/artifactory_local_*_repository: Adds new data sources for all local repository types.
  PR:    [#677](https://github.com/jfrog/terraform-provider-artifactory/pull/677)
  Issue: [#548](https://github.com/jfrog/terraform-provider-artifactory/issues/548)
