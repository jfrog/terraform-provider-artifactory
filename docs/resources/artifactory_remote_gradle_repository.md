...
All generic repo arguments are supported, in addition to Gradle specific arguments. [Reference](https://www.jfrog.com/confluence/display/JFROG/Remote+Repositories#RemoteRepositories-Maven,Gradle,IvyandSBTRepositories)
