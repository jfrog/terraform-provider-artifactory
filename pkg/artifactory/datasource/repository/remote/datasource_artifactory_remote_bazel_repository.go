...
var _ datasource.DataSource = &RemoteBazelRepositoryDataSource{}

func NewRemoteBazelRepositoryDataSource() datasource.DataSource {
	return &RemoteBazelRepositoryDataSource{}
}

type RemoteBazelRepositoryDataSource struct {
	ProviderData util.ProviderMetadata
}

type RemoteBazelRepositoryDataSourceModel struct {
	BaseRemoteRepositoryDataSourceModel
}

type RemoteBazelRepositoryAPIModel struct {
	resourceremote.RemoteAPIModel
}

func (d *RemoteBazelRepositoryDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	// The Artifactory package type is `bazelmodules`, but the data source is
	// exposed with the shorter `artifactory_remote_bazel_repository` name.
	resp.TypeName = "artifactory_remote_bazel_repository"
}

func (d *RemoteBazelRepositoryDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Attributes:  BaseRemoteSchemaAttributes(),
		Description: "Provides a data source for a remote Bazel Modules repository",
	}
}

func (d *RemoteBazelRepositoryDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RemoteBazelRepositoryDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data RemoteBazelRepositoryDataSourceModel
	...
	var apiModel RemoteBazelRepositoryAPIModel
...
func (m *RemoteBazelRepositoryDataSourceModel) FromAPIModel(ctx context.Context, apiModel *RemoteBazelRepositoryAPIModel) diag.Diagnostics {
	...
	baseAPIModel := datasource_repository.BaseRepositoryAPIModel{
		...
		PackageType:         repository.BazelModulesPackageType,
	}
