...
var _ datasource.DataSource = &RemoteNimModelRepositoryDataSource{}

func NewRemoteNimModelRepositoryDataSource() datasource.DataSource {
	return &RemoteNimModelRepositoryDataSource{}
}

type RemoteNimModelRepositoryDataSource struct {
	ProviderData util.ProviderMetadata
}

type RemoteNimModelRepositoryDataSourceModel struct {
	BaseRemoteRepositoryDataSourceModel
	EnableTokenAuthentication types.Bool `tfsdk:"enable_token_authentication"`
}

type RemoteNimModelRepositoryAPIModel struct {
	resourceremote.RemoteAPIModel
	EnableTokenAuthentication bool `json:"enableTokenAuthentication"`
}

func (d *RemoteNimModelRepositoryDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "artifactory_remote_nimmodel_repository"
}

func (d *RemoteNimModelRepositoryDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		...
		Description: "Provides a data source for a remote NVIDIA NIM repository",
	}
}

func (d *RemoteNimModelRepositoryDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *RemoteNimModelRepositoryDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data RemoteNimModelRepositoryDataSourceModel
	...
	var apiModel RemoteNimModelRepositoryAPIModel
...
func (m *RemoteNimModelRepositoryDataSourceModel) FromAPIModel(ctx context.Context, apiModel *RemoteNimModelRepositoryAPIModel) diag.Diagnostics {
	...
	baseAPIModel := datasource_repository.BaseRepositoryAPIModel{
		...
		PackageType:         repository.NimModelPackageType,
	}
