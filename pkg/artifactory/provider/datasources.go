...
import (
	...
	datasource_federated "github.com/jfrog/terraform-provider-artifactory/v11/pkg/artifactory/datasource/repository/federated"
	datasource_local "github.com/jfrog/terraform-provider-artifactory/v11/pkg/artifactory/datasource/repository/local"
	datasource_remote "github.com/jfrog/terraform-provider-artifactory/v11/pkg/artifactory/datasource/repository/remote"
	datasource_virtual "github.com/jfrog/terraform-provider-artifactory/v11/pkg/artifactory/datasource/repository/virtual"
	datasource_security "github.com/jfrog/terraform-provider-artifactory/v11/pkg/artifactory/datasource/security"
	datasource_user "github.com/jfrog/terraform-provider-artifactory/v11/pkg/artifactory/datasource/user"
...
func datasourcesMap() map[string]*schema.Resource {
	dataSourcesMap := map[string]*schema.Resource{
		...
		"artifactory_local_ansible_repository":                datasource_local.DataSourceArtifactoryLocalAnsibleRepository(),
		...
		"artifactory_local_helmoci_repository":                datasource_local.DataSourceArtifactoryLocalHelmOciRepository(),
		...
		"artifactory_local_oci_repository":                    datasource_local.DataSourceArtifactoryLocalOciRepository(),
		...
		"artifactory_remote_ansible_repository":               datasource_remote.DataSourceArtifactoryRemoteAnsibleRepository(),
		...
		"artifactory_remote_cocoapods_repository":             datasource_remote.DataSourceArtifactoryRemoteCoapodsRepository(),
		"artifactory_remote_composer_repository":              datasource_remote.DataSourceArtifactoryRemoteComposerRepository(),
		...
		"artifactory_remote_helmoci_repository":               datasource_remote.DataSourceArtifactoryRemoteHelmOciRepository(),
		...
		"artifactory_remote_oci_repository":                   datasource_remote.DataSourceArtifactoryRemoteOciRepository(),
		...
		"artifactory_virtual_helmoci_repository":              datasource_virtual.DatasourceArtifactoryVirtualHelmOciRepository(),
		...
		"artifactory_virtual_oci_repository":                  datasource_virtual.DatasourceArtifactoryVirtualOciRepository(),
		...
		"artifactory_federated_ansible_repository":            datasource_federated.DataSourceArtifactoryFederatedAnsibleRepository(),
		...
		"artifactory_federated_helmoci_repository":            datasource_federated.DataSourceArtifactoryFederatedHelmOciRepository(),
		...
		"artifactory_federated_oci_repository":                datasource_federated.DataSourceArtifactoryFederatedOciRepository(),
