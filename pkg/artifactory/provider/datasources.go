...
import (
	...
	datasource_federated "github.com/jfrog/terraform-provider-artifactory/v12/pkg/artifactory/datasource/repository/federated"
	...
	datasource_security "github.com/jfrog/terraform-provider-artifactory/v12/pkg/artifactory/datasource/security"
	datasource_user "github.com/jfrog/terraform-provider-artifactory/v12/pkg/artifactory/datasource/user"
...
func datasourcesMap() map[string]*schema.Resource {
	dataSourcesMap := map[string]*schema.Resource{
		...
		"artifactory_local_composer_repository":               datasource_local.DataSourceArtifactoryLocalComposerRepository(),
		...
		"artifactory_remote_conda_repository":                 datasource_remote.DataSourceArtifactoryRemoteCondaRepository(),
		...
		"artifactory_federated_composer_repository":           datasource_federated.DataSourceArtifactoryFederatedComposerRepository(),
