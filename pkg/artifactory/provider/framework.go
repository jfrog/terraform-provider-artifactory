...
func (p *ArtifactoryProvider) Resources(ctx context.Context) []func() resource.Resource {
	...
	return append(
		...
		[]func() resource.Resource{
			...
			remote.NewCocoapodsRemoteRepositoryResource,
			remote.NewComposerRemoteRepositoryResource,
			remote.NewCondaRemoteRepositoryResource,
			remote.NewConanRemoteRepositoryResource,
			remote.NewDebianRemoteRepositoryResource,
			remote.NewDockerRemoteRepositoryResource,
			remote.NewGemsRemoteRepositoryResource,
			remote.NewGenericRemoteRepositoryResource,
			remote.NewGoRemoteRepositoryResource,
			...
			remote.NewAIEditorExtensionsRemoteRepositoryResource,
			...
			remote.NewNimModelRemoteRepositoryResource,
			remote.NewJavaRemoteRepositoryResource(repository.IvyPackageType, true),
			remote.NewMavenRemoteRepositoryResource,
			remote.NewNPMRemoteRepositoryResource,
			remote.NewNugetRemoteRepositoryResource,
			remote.NewOCIRemoteRepositoryResource,
			remote.NewPyPIRemoteRepositoryResource,
			remote.NewJavaRemoteRepositoryResource(repository.SBTPackageType, true),
			remote.NewTerraformRemoteRepositoryResource,
			remote.NewVCSRemoteRepositoryResource,
...
func (p *ArtifactoryProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		datasource_remote.NewRemoteAIEditorExtensionsRepositoryDataSource,
		datasource_remote.NewRemoteHexRepositoryDataSource,
		datasource_remote.NewRemoteNimModelRepositoryDataSource,
