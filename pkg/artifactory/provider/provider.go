	...
	p := &schema.Provider{
		Schema: map[string]*schema.Schema{
			...
			"access_token": {
				...
				Description: "(Optional) This is a access token that can be given to you by your admin under `Identity and Access`. If not set, the 'api_key' attribute value will be used.",
			},
			"check_license": {
