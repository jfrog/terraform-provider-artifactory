...
func TestAccPackageCleanupPolicy_all_package_types(t *testing.T) {
	...
	allPackageTypes := "[\"alpine\", \"ansible\", \"cargo\", \"chef\", \"cocoapods\", \"composer\", \"conan\", \"conda\", \"debian\", \"docker\", \"gems\", \"generic\", \"go\", \"gradle\", \"helm\", \"helmoci\", \"huggingfaceml\", \"machinelearning\", \"maven\", \"npm\", \"nuget\", \"oci\", \"opkg\", \"puppet\", \"pypi\", \"sbt\", \"swift\", \"terraform\", \"terraformbackend\", \"vagrant\", \"yum\"]"
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(fqrn, "search_criteria.package_types.#", "31"),
				),
			},
		},
	})
