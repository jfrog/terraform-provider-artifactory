...
func TestAccRemoteHelmOCIRepository_DependenciesTrueAndFalseToggle(t *testing.T) {
	_, fqrn, name := testutil.MkNames("test-helmoci-remote", "artifactory_remote_helmoci_repository")
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: util.ExecuteTemplate("TestAccRemoteHelmOCIRepository_DependenciesTrueAndFalseToggle", temp, params),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(fqrn, "key", name),
					resource.TestCheckResourceAttr(fqrn, "external_dependencies_enabled", "true"),
			...
			{
				Config: util.ExecuteTemplate("TestAccRemoteHelmOCIRepository_DependenciesTrueAndFalseToggle", tempUpdate, params),
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(fqrn, "key", name),
